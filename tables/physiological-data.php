	...
	<fieldset>
		<table>
			<tr>
				...
				<td class="a-right"><input type="text" name="processed_physiological_data[age]" value="<?php echo $this->getPost('processed_physiological_data', 'age') ?>" readonly disabled /></td>
