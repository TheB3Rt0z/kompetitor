	...
	<fieldset>
		<table>
			<tr>
				...
				<td class="a-left" colspan="2"><?php echo ucfirst(trnslt('average weight')) ?> <strong><?php echo $this->getPost('processed_physiological_data', 'mediated_weekly_weight') ?></strong> (in kg, ATM <strong><?=($weight_diff>=0?'<font color="#a00">+':'<font color="#0a0">').number_format($weight_diff, 3).'</font>'?></strong>):</td>
